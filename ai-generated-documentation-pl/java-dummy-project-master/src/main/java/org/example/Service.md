...
- Ważna logika: Metoda używa zagnieżdżonych instrukcji if-else do określenia znaków podanych liczb i wypisania odpowiednich stwierdzeń.
...
// Metoda: isEven(int input)
  1. Sprawdź, czy wejście jest parzyste, używając operatora modulo (input % 2 == 0)
  2. Zwróć prawdę, jeśli wejście jest parzyste, w przeciwnym razie fałsz
